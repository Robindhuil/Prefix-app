                                ...
                                <div className="p-6 pr-10 rounded-2xl border-2 border-[#600000]/10 hover:border-[#600000]/40 hover:shadow-2xl transition-all duration-300 bg-gradient-to-r from-[#600000]/5 to-transparent">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <span className={`text-xs px-3 py-1.5 rounded-full font-bold ${active ? "bg-green-100 text-green-800" : "bg-[#600000]/10 text-[#600000]"}`}>
                                                #{a.workPeriod.id}
                                            </span>
                                            <ArrowRight className="w-5 h-5 text-[#600000] group-hover:translate-x-2 transition" />
                                        </div>
                                    </div>
                                    ...
                                    <p className="text-sm text-gray-600 mt-3 flex items-center gap-2">
                                        ...
                                        {active && <span className="ml-3 text-green-600 font-bold text-xs">→ AKTÍVNE</span>}
                                    </p>
                                </div>
                            </Link>
                        );
